...
function doLogin()
{
	...
	let tmp = {login:login, password:hash}; // Use the hashed password
...
function doRegister()
{
	...
	let tmp = {login:login, password:hash, firstName:firstName, lastName:lastName}; // Use the hashed password
	let jsonPayload = JSON.stringify(tmp);
...
function editContact()
{
	...
	let tmp = {contactId:contactId, newContact:newContact, userId:userId};
	let jsonPayload = JSON.stringify( tmp );
